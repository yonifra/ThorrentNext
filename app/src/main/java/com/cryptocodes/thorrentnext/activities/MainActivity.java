...
import com.cryptocodes.thorrentnext.RetrieveFeed;
...
public class MainActivity extends AppCompatActivity
        ...
        try {
            ...
            itemsListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                    ...
                    i.putExtra("resolution", movie.getResolution());
                    i.putExtra("year", movie.getYear());
                    i.putExtra("releaseType", movie.getReleaseType());
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_movies) {
            getItemsByCategory("films");
        } else if (id == R.id.nav_tvseries) {
            getItemsByCategory("tv");
